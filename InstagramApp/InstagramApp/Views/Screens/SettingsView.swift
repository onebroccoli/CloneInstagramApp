    ...
    var body: some View {
        NavigationView {
            ScrollView(.vertical, showsIndicators: false, content:{
                GroupBox(label: SettingsLabelView(labelText: "InstaDog", labelImage: "dot.radiowaves.left.and.right"), content: {
                ...
                GroupBox(label: SettingsLabelView(labelText: "Profile", labelImage: "person.fill"), content: {
                    ...
                    NavigationLink(
                        destination: SettingsEditTextView(submissionText: userDisplayName, title: "Display Name", description: "You can add your display name here. This will be seen by other users on your profile and on your posts!", placeholder: "Your display name here...", settingsEditTextOption: .displayName, profileText: $userDisplayName),
                        label: {
            ...
            // MARK: SECTION 3: APPLICATION
                GroupBox(label: SettingsLabelView(labelText: "Application", labelImage: "apps.iphone"), content: {
                    ...
                    Button(action: {
                        ...
                        SettingsRowView(leftIcon: "globe", text: "InstaDog Website", color: Color.MyTheme.yellowColor)
                    })
